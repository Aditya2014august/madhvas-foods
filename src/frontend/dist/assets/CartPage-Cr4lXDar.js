...
const BadgePercent = createLucideIcon("badge-percent", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const PlaceOrderRequest = Record({
  ...
  "paymentMethod": Text,
  "customerPhone": Text,
  "items": Vec(Tuple(MenuItemId, Nat))
});
...
Service({
  ...
  "getOrderStatus": Func([OrderId], [Opt(OrderStatus)], ["query"]),
  "getOrdersByStatus": Func(
    [OrderStatus],
    [Vec(OrderPublic)],
    ["query"]
  ),
  "placeOrder": Func([PlaceOrderRequest], [OrderPublic], []),
  "transform": Func(
    [TransformationInput],
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const PlaceOrderRequest2 = IDL2.Record({
    ...
    "paymentMethod": IDL2.Text,
    "customerPhone": IDL2.Text,
    "items": IDL2.Vec(IDL2.Tuple(MenuItemId2, IDL2.Nat))
  });
  ...
  return IDL2.Service({
    ...
    "getOrdersByStatus": IDL2.Func(
      [OrderStatus2],
      [IDL2.Vec(OrderPublic2)],
      ["query"]
    ),
    "placeOrder": IDL2.Func([PlaceOrderRequest2], [OrderPublic2], []),
    "transform": IDL2.Func(
...
class Backend {
  ...
  async getMenuItemsByCategory(arg0) {
    if (this.processError) {
      try {
        const result = await this.actor.getMenuItemsByCategory(to_candid_MenuCategory_n14(this._uploadFile, this._downloadFile, arg0));
        return from_candid_vec_n8(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async placeOrder(arg0) {
    if (this.processError) {
      try {
        ...
        return from_candid_OrderPublic_n17(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
...
function from_candid_MenuCategory_n11(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n12(_uploadFile, _downloadFile, value);
}
async function from_candid_MenuItem_n9(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n10(_uploadFile, _downloadFile, value);
}
function from_candid_OrderPublic_n17(_uploadFile, _downloadFile, value) {
  return from_candid_record_n18(_uploadFile, _downloadFile, value);
}
function from_candid_OrderStatus_n19(_uploadFile, _downloadFile, value) {
...
function from_candid_opt_n16(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_OrderPublic_n17(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n10(_uploadFile, _downloadFile, value) {
  return {
    ...
    category: from_candid_MenuCategory_n11(_uploadFile, _downloadFile, value.category),
...
function from_candid_variant_n12(_uploadFile, _downloadFile, value) {
  return "Burger" in value ? "Burger" : "Pizza" in value ? "Pizza" : "Sandwiches" in value ? "Sandwiches" : "Beverages" in value ? "Beverages" : "Maggi" in value ? "Maggi" : "Momos" in value ? "Momos" : value;
}
function from_candid_variant_n20(_uploadFile, _downloadFile, value) {
  return "Delivered" in value ? "Delivered" : "Ready" in value ? "Ready" : "Baking" in value ? "Baking" : "Preparing" in value ? "Preparing" : "OutForDelivery" in value ? "OutForDelivery" : value;
}
function from_candid_vec_n24(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_OrderPublic_n17(_uploadFile, _downloadFile, x));
}
async function from_candid_vec_n8(_uploadFile, _downloadFile, value) {
  return await Promise.all(value.map(async (x) => await from_candid_MenuItem_n9(_uploadFile, _downloadFile, x)));
}
function to_candid_MenuCategory_n14(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function to_candid_OrderStatus_n22(_uploadFile, _downloadFile, value) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-0.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-foreground font-display line-clamp-1", children: ci.item.name })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-0.5 bg-muted rounded-full px-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold min-w-[22px] text-center tabular-nums", children: ci.quantity }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-sm text-foreground min-w-[44px] text-right tabular-nums", children: [
            "₹",
...
function CartPage() {
  ...
  const handlePromo = () => {
    if (!form.promoCode.trim()) {
      ue.error("Enter a promo code first");
      return;
    }
    if (form.promoCode.trim().toUpperCase() === "MADHVAS10") {
      setPromoApplied(true);
      ue.success("Promo applied! 10% off your order 🎉");
    } else {
      ue.error("Invalid promo code");
    }
  };
  ...
  const handlePlaceOrder = async () => {
    ...
    if (actor) {
      actor.placeOrder({
        ...
        paymentMethod: paymentMethod === "cod" ? "Cash on Delivery" : "Card / UPI",
  ...
  if (items.length === 0 && !isPlacing) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-2xl mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { variant: "cart" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-6 pb-24 space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold font-display", children: "Your Cart" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "aria-label": "Cart items", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "cart.items_list", className: "space-y-2.5", children: items.map((ci, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        CartItemRow,
        {
          ci,
          idx: i + 1,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(BadgePercent, { size: 16, className: "text-primary" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm font-display", children: "Promo Code" }),
        promoApplied && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-green-100 text-green-700 border-green-200 text-xs font-semibold ml-auto", children: "MADHVAS10 applied" })
      ] }),
      !promoApplied ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-green-700 font-medium flex items-center gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border p-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-base", children: "Order Summary" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
        ...
        promoApplied && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-green-700 font-medium", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Promo Discount (10%)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "−₹",
            promoDiscount
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "GST & charges (5%)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "₹",
            gst
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground", children: "Inclusive of all taxes. No hidden charges." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl border border-border p-4 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-base flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Label,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 13, className: "text-muted-foreground" }),
              "Full Name ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { msg: errors.houseNo })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(FieldError, { msg: errors.area })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `flex items-center gap-2.5 p-3 rounded-xl border-2 text-left transition-smooth ${form.paymentMethod === "cod" ? "border-primary bg-primary/5" : "border-border hover:border-primary/40"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: form.paymentMethod === "cod" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-primary block" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold text-foreground flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Banknote, { size: 12, className: "text-green-600" }),
                  "Cash on Delivery"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "Pay at door" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `flex items-center gap-2.5 p-3 rounded-xl border-2 text-left transition-smooth ${form.paymentMethod === "card" ? "border-primary bg-primary/5" : "border-border hover:border-primary/40"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: form.paymentMethod === "card" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-primary block" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-bold text-foreground flex items-center gap-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CreditCard, { size: 12, className: "text-primary" }),
                  "Card / UPI"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "Online payment" })
              ] })
            ]
          }
        )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { open: showConfirm, onOpenChange: setShowConfirm, children: [
        ...
        AlertDialogContent,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "font-display text-lg", children: "Confirm Your Order" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm space-y-3 text-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-muted/40 rounded-xl p-3 space-y-1.5", children: items.map((ci) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/40 rounded-xl p-3 space-y-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground", children: "Delivering to" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                    form.houseNo,
                    ", ",
                    form.area,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: form.paymentMethod === "cod" ? "💵 Cash on Delivery" : "💳 Card / UPI" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-[11px] text-muted-foreground pb-2", children: "By placing your order you agree to our delivery terms. Estimated delivery: 30–45 minutes." })
  ] });
}
export {
  CartPage
