...
import type { ExternalBlob as _ExternalBlob, MenuCategory as _MenuCategory, MenuItem as _MenuItem, MenuItemId as _MenuItemId, OrderId as _OrderId, OrderItem as _OrderItem, OrderPublic as _OrderPublic, OrderStatus as _OrderStatus, Timestamp as _Timestamp, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getOrdersByStatus(arg0: OrderStatus): Promise<Array<OrderPublic>> {
        if (this.processError) {
            try {
...
function from_candid_MenuCategory_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MenuCategory): MenuCategory {
    return from_candid_variant_n12(_uploadFile, _downloadFile, value);
}
async function from_candid_MenuItem_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MenuItem): Promise<MenuItem> {
    return await from_candid_record_n10(_uploadFile, _downloadFile, value);
}
function from_candid_OrderPublic_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OrderPublic): OrderPublic {
...
function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_OrderPublic]): OrderPublic | null {
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "Burger" in value ? MenuCategory.Burger : "Pizza" in value ? MenuCategory.Pizza : "Sandwiches" in value ? MenuCategory.Sandwiches : "Beverages" in value ? MenuCategory.Beverages : "Maggi" in value ? MenuCategory.Maggi : "Momos" in value ? MenuCategory.Momos : value;
}
function from_candid_variant_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "Delivered" in value ? OrderStatus.Delivered : "Ready" in value ? OrderStatus.Ready : "Baking" in value ? OrderStatus.Baking : "Preparing" in value ? OrderStatus.Preparing : "OutForDelivery" in value ? OrderStatus.OutForDelivery : value;
}
function from_candid_vec_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_OrderPublic>): Array<OrderPublic> {
    return value.map((x)=>from_candid_OrderPublic_n17(_uploadFile, _downloadFile, x));
}
async function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MenuItem>): Promise<Array<MenuItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MenuItem_n9(_uploadFile, _downloadFile, x)));
}
function to_candid_MenuCategory_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MenuCategory): _MenuCategory {
...
function to_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: MenuCategory): {
    Burger: null;
} | {
    Pizza: null;
} | {
    ...
    return value == MenuCategory.Burger ? {
        Burger: null
        ...
        Beverages: null
    } : value == MenuCategory.Maggi ? {
        Maggi: null
    } : value == MenuCategory.Momos ? {
        Momos: null
    } : value;
}
